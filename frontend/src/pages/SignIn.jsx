  ...
  return (
    ...
    >
        <div className='bg-white p-8 rounded-lg shadow-md w-full max-w-md border' style={{borderColor: `var(--border)`}}>
            ...
            <p className='text-gray-600 mb-6 text-center'>Welcome back! glad to see you again</p>
            <form onSubmit={handleSignIn}>
                ...
                <div className='mb-4 relative'>
                    ...
                    <div className="relative">
                        ...
                        <p className='text-[#ff4d2d] capitalize text-sm text-right cursor-pointer hover:underline transition-colors duration-300' onClick={() => navigate("/forgot-password")}>forgot password</p>
                    </div>
                </div>
